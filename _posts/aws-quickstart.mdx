---
imageurl: 'https://upload.wikimedia.org/wikipedia/commons/5/5c/AWS_Simple_Icons_AWS_Cloud.svg'
title: 'Getting Started with AWS'
subtitle: 'Create an AWS account and set up CLI/SDK access.'
author: 'Pixegami - Github'
publishedAt: 'April 17, 2024'
credits: 'Photo by Wikipedia/commons'
tags: ['aws', 'cloud', 'cli', 'sdk', 'nextjs']
---
...
```javascript
// test for rehype-highlight during development
