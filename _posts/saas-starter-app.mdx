---
imageurl: 'https://images.pexels.com/photos/19867468/pexels-photo-19867468/free-photo-of-scrabble-letters-spelling-saas-on-a-wooden-table.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
title: 'Building a serverless SaaS product'
subtitle: 'A full-stack SaaS project with authentication and payments.'
author: 'Pixegami - Github'
publishedAt: 'April 17, 2024'
credits: 'Photo by Markus Winkler - Pexels'
tags: ['saas', 'serverless', 'authentication', 'payments']
---
...
My implementation is opinionated (as you'll see), and intended to serve as a starting point for new SaaS ideas in the future.
