...
You can view the example at [https://saas-starter-stack.com/app/](https://saas-starter-stack.com/app/) and the source on [GitHub](https://github.com/pixegami/saas-starter). In this post, I'll be reflecting on my choices and experience for each of the above features.
