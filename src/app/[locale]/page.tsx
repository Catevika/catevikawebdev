  ...
  return (
    <section className={styles.home__container}>
      <div className={styles.home__background}>
        ...
        <Image data-hide-on-theme="light" className={styles.home__background__image2dark} src={catevikaImg} alt='' width={0} height={0} sizes="50vw" placeholder='blur' priority />
        <Image data-hide-on-theme="dark" className={styles.home__background__image2light} src={catevika2Img} alt='' width={0} height={0} sizes="50vw" placeholder='blur' priority />
      </div>
