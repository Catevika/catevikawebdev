...
import { barlow, oswald } from './font';
  ...
  return (
    <main className='container'>
      ...
      <div className={styles.home__content}>
        <h2 className={barlow.className}>Your tailor-made website in just a few clicks!</h2>
        <button>Ask for a quotation</button>
        <Link href={'/services'}>Learn more about our Services</Link>
        <h1 className={oswald.className}>Catevika Web Dev</h1>
        <p className={barlow.className}>catevikawebdev@outlook.fr</p>
      </div>
    </main>
  );
}
