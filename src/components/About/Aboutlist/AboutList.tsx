...
export default function AboutList() {
  ...
  return (
    <>
      <motion.section className={styles.about__top__container}
        initial={{ x: '100vw' }}
        animate={{ x: 0 }}
        transition={{ ease: "easeInOut", duration: 1.5 }}
      >
        <Image className={styles.about__top__image} src={profileImg} alt={t('alt1')} height={250} width={250} placeholder='blur' priority />
      ...
      <h3>{t('name')}</h3>
      <motion.section className={styles.about__middle__container}
        initial={{ x: '-100vw' }}
        animate={{ x: 0 }}
        transition={{ ease: "easeInOut", duration: 1.5 }}
      >
        ...
        <Image className={styles.about__middle__image} src={cattivikImg} alt={t('alt2')} height={292} width={216} placeholder='blur' priority />
      </motion.section>
      <h3>{t('seahorseSymbol')}</h3>
      <motion.section className={styles.about__bottom__container}
        initial={{ x: '100vw' }}
        animate={{ x: 0 }}
        transition={{ ease: "easeInOut", duration: 1.5 }}
      >
        <Image data-hide-on-theme='light' className={styles.about__bottom__image__dark} src={catevikaImg} alt={t('alt3')} height={292} width={292} placeholder='blur' priority />
        <Image data-hide-on-theme='dark' className={styles.about__bottom__image__light} src={catevika2Img} alt={t('alt3')} height={292} width={292} placeholder='blur' priority />
